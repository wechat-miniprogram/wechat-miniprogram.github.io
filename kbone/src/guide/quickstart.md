...
> PS：项目基于 webpack 构建，关于 webpack 方面的配置可以[点此查看](https://webpack.js.org/configuration/)，而关于小程序构建相关的详细配置细节可以[参考此文档](./tutorial)。
...
* 使用 webpack 构建中使用到的特殊插件[ mp-webpack-plugin 配置](../config/)

[点此可以查看](./tutorial)具体配置方式和操作流程。
